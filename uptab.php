...
$tabup="UPDATE sample_member SET last_name='$Lname', first_name='$Fname', work='$work' WHERE card_id='012e4cd486597ec4'";
//$tabup="UPDATE sample_member SET last_name='島井' WHERE card_id='012e4cd486597ec4'";
try{
